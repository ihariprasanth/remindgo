...
$targets = @(
    "release\RemindGo-Setup-2.9.5.exe",
    "release\RemindGo-Portable-2.9.5.exe",
    "D:\PROJECTS\RemindGo\v2.9.5\RemindGo-Setup-2.9.5.exe",
    "D:\PROJECTS\RemindGo\v2.9.5\RemindGo-Portable-2.9.5.exe",
    "C:\Users\HARIPRASANTH\Desktop\RemindGo App\RemindGo-Setup-2.9.5.exe",
    "C:\Users\HARIPRASANTH\Desktop\RemindGo App\RemindGo Setup 2.9.5.exe",
    "C:\Users\HARIPRASANTH\Desktop\RemindGo App\RemindGo-Portable-2.9.5.exe"
)
